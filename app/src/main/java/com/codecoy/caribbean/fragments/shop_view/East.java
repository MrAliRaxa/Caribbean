...
import com.codecoy.caribbean.databinding.FragmentEastBinding;
...
public class East extends Fragment {
    ...
    private Shop shop;
    private FragmentEastBinding mDataBinding;
    public East() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDataBinding= DataBindingUtil.inflate(inflater,R.layout.fragment_east, container, false);
